...
//
// `GET /health` is short-circuited to the shared health JSON before any app
// rendering (see @remindit/common/health): always 200 while the process is
// alive, serving monitoring tools and bm2 without running the React graph.
//
...
const health = healthFetchHandler("remindit-web", { version: webPkg.version })
