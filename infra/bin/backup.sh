...
# superuser API. Sources the repo-root .env (so superuser credentials resolve)
# and self-locates the repo root. The answer half is best-effort: its failure
# must not block the pb_data/ backup that follows.
set -e
