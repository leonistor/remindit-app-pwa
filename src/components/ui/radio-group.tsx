...
export const RadioGroupText = (
  ...
  return (
    <FieldLabel render={<ArkRadioGroup.ItemText data-slot="radio-group-item-text" {...rest} />}>{children}</FieldLabel>
  );
};
...
export const RadioGroupLabel = (
  ...
  return (
    <FieldLabel render={<ArkRadioGroup.Label data-slot="radio-group-label" {...rest} />}>{children}</FieldLabel>
  );
};
